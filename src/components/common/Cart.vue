...
<template>
  <div class="cart">
    <div class="cart-title">
      购物车
      <span class="clear" @click="clearOrder">[清空]</span>
    </div>
    <div class="cart-list">
      <ul>
        <li v-for="(item, index) in activeOrder" :key="index">
          <div class="cart-item">
    ...
    <div class="cart-sum">
      <div class="sum-l">
        <div class="car">
          ...
          <span class="cost-all">{{totalCost}}</span>
        </div>
...
export default {
  ...
  props: ["orderList", "deliveryFee","shopId",'shopName'],
  components: {},
